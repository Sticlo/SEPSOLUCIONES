...
export const SERVICIOS: Servicio[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    keywords: 'destapes bogota, destape desagues bogota, destape desagues bogota, desobstruccion desagues bogota, plomero destapes bogota, destape sifones bogota, destape cañerias bogota, servicio destapes bogota 24 horas',
    icono: '🔧',
